    ...
    <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 30px;">
        ...
        <div class="card" style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); text-align: center; height: fit-content;">
            ...
            <div id="image-preview-container">
                @if($user->photo)
                    {{-- Tambahkan ?t=time() untuk menghindari cache browser --}}
                ...
                @else
                    ...
                    {{-- Placeholder IMG (Hidden) untuk preview saat user pilih file --}}
    ...
    function showPreview(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                if (initial) {
                    initial.style.display = 'none'; // Sembunyikan huruf U
                }
            }
