        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($p->penawaran && ($p->penawaran->status == 'sent' || $p->penawaran->status == 'accepted' || $p->penawaran->status == 'converted'))
                        <span style="color: #27ae60; font-weight: bold; font-size: 16px;">
                            Rp {{ number_format($p->penawaran->total, 0, ',', '.') }}
                        </span>
                        @else
                    ...
                    <td style="text-align: center;">
                        @if($p->penawaran && $p->penawaran->status == 'sent')
                        ...
                        <button class="btn-action btn-reject" disabled>Nego</button>
